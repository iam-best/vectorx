...
func RockPaperScissors_Register(intentList *[]IntentDef) error {
	...
	*intentList = append(*intentList, intent)
	...
	addLocalizedString("STR_ENOUGH", []string{"Ok, I think it's enough", "Penso che possa bastare", "Bien, creo que es suficiente", "bien, je pense que ça suffit!", "Ok, ich glaube, es reicht"})
	...
	addLocalizedString("STR_SORRY_I_DONT_GET_IT", []string{"sorry, I don't get it", "scusa non l'ho capita", "Lo siento, no lo entiendo", "Désolé, je ne comprends pas", "sorry, ich verstehe nicht"})
